...
_Mục tiêu: Đưa file lên 2 cấp thư mục._
...
_Giải thích:_ Server kiểm tra thấy đuôi `.jpg` (hợp lệ), nhưng khi lưu xuống đĩa, hệ điều hành cắt bỏ phần sau `%00`, chỉ lưu thành `shell.php`.
